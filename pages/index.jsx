...
export default function Home() {
  ...
  return (
    ...
    <div className="relative overflow-x-hidden  bg-[#DFF1FF]">
      <Nav scrollContact={scrollContact} scrollAbout={scrollAbout} scrollSkills={scrollSkills} scrollProjects={scrollProjects}  />
    ...
    <footer  class="p-4 mr-[15%] bg-[#DFF1FF] rounded-lg shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800">
