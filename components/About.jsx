  ...
  return (
    <div className="px-[10%] pt-48 flex " id="about">
      ...
      <div className="w-full h-auto  pl-[10%]">
        ...
        <h1 className=" mx-2 text-4xl   ">About<span className="mx-2"></span>Me</h1>
          <div className="h-1 w-full bg-black"></div>
        </div>
        ...
        <div className="flex mt-5 justify-around w-[80%]">
          <div className="border-2 h-32 w-32 bg-red-500 rounded-2xl text-center flex flex-col justify-around items-center text-white">
