      ...
      <div className=" flex justify-center items-center px-[15%] h-full">
        <div>
          ...
          <p className="mb-[5%] text-lg lg:text-xl mr-[25%]">
            I am a web developer ready to do work in front-end and back-end,
            designing mobile first, responsive applications.
          </p>
          <button
            ...
            } bg-red-500 py-2 px-3 rounded-full text-white shadow-lg`}
          >
            Learn More
          </button>
        </div>
